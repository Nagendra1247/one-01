...
<head>
    ...
    <title>DevOps with aws trainee Portfolio</title>
    <style>
        /* General Styles */
        body {
...
<body>
    <header>
        <h1>Nagendra venkatasai -DevOps with aws trainee</h1>
    ...
    <section id="about" class="about">
        <h2>About Me</h2>
        <p>Hello! I'm Nagendra Gullupalli from savaram from andhra pradesh.I have completed my graduation in information technology.Currently i am learning devops with aws in flm</p>
    </section>
    ...
    <footer>
        <p>© 2024 Nagendra | DevOps Trainee Portfolio | <a href="#about">Back to Top</a></p>
    </footer>
</body>
</html>
